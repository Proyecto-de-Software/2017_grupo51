...
@section('content')
        <div class="container">
			...
			<div class="form-group">
				<label>Peso(*):</label>
				<input type="number" class="form-control" name="peso" id="PesoPac" placeholder="Ingrese el peso" value="@if (! empty($control)){{ $control['peso'] }} @elseif (! empty(old('peso'))) {{ old('peso') }}@endif" required>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<input type="number" class="form-control" name="percentilo_cefalico" id="PC" placeholder="Ingrese valor" value="@if (! empty($control)){{ $control['percentilo_cefalico'] }} @elseif (! empty(old('percentilo_cefalico'))) {{ old('percentilo_cefalico') }}@endif">
			</div>
			<div class="form-group">
				<label>PPC: Percentilo perímetro cefálico</label>
				<input type="number" class="form-control" name="percentilo_perimetro_cefalico" id="PPC" placeholder="Ingrese valor" value="@if (! empty($control)){{ $control['percentilo_perimetro_cefalico'] }} @elseif (! empty(old('percentilo_perimetro_cefalico'))) {{ old('percentilo_perimetro_cefalico') }}@endif">
			</div>
			<div class="form-group">
				<label>Talla:</label>
				<input type="number" class="form-control" name="talla" id="TallaPac" placeholder="Ingrese la Talla" value="@if (! empty($control)){{ $control['talla'] }} @elseif (! empty(old('talla'))) {{ old('talla') }}@endif">
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				<label>Observaciones Grales:</label>
